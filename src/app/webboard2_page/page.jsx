    ...
    <>
      <Head>
        <link
          ...
          integrity="sha512-k6RqeWeciY+d5dRW0bSXYt2+1w9JGZNRlHuvHy5HhMoY6v2tb5RErOP9U4q6aHuE2cRVh5DkD3ghfX1IDjS9mg=="
        ...
        <main className="flex-grow">
          ...
          >
            ...
            <div className="flex justify-center space-x-4 mt-6">
              ...
              <button className="border border-purple-500 text-purple-500 rounded-full px-4 py-1 hover:bg-purple-100 whitespace-nowrap">
                เว็บบอร์ด
              </button>
            </div>
          </div>
          ...
          <div className="bg-white mx-auto mb-12 max-w-2xl rounded-lg shadow-md p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
              <a
                href="/webboard1_page"
                className="text-black hover:text-purple-700 font-bold text-xl"
                title="ย้อนกลับ"
              >
